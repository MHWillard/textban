...
If you run the App, add some items and close it, you should see a new file in `%APPDATA%\Avalonia.textban` called `MyToDoList.txt` with a content similar to this:
